...
public class BruiserAbility extends AbstractAbilityCard {
    public final static String ID = makeID(BruiserAbility.class.getSimpleName());
    public static final AbilityManager.AbilityType TYPE = AbilityManager.AbilityType.BRUISER;

    public BruiserAbility() {
        super(ID, TYPE);
