...
public class LouseGold extends CustomMonster {
    public static final String ID = TheStarsAboveMod.makeID(LouseGold.class.getSimpleName());
    ...
    public LouseGold(float x, float y) {
        super(NAME, ID, 15, 0.0F, -5.0F, 180.0F, 140.0F, (String)null, x, y);
        this.loadAnimation("StarlightResources/images/monsters/LouseGold/skeleton.atlas", "StarlightResources/images/monsters/LouseGold/skeleton.json", 1.0F);
    ...
    public void usePreBattleAction() {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new PlatedArmorPower(this, 2)));
        AbstractDungeon.actionManager.addToBottom(new GainBlockAction(this, this, 2));
    }
    ...
    public void takeTurn() {
        switch(this.nextMove) {
            ...
            case 4:
                ...
                if (AbstractDungeon.ascensionLevel >= 17) {
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new PlatedArmorPower(this, STR_AMOUNT+1), STR_AMOUNT+1));
                } else {
                    AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(this, this, new PlatedArmorPower(this, STR_AMOUNT), STR_AMOUNT));
                }
    ...
    protected void getMove(int num) {
        if (this.hasPower(PlatedArmorPower.POWER_ID) && this.getPower(PlatedArmorPower.POWER_ID).amount >= 10) {
