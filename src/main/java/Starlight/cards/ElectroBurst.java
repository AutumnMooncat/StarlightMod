...
import Starlight.actions.SparkVFXAction;
...
public class ElectroBurst extends AbstractEasyCard {
    public final static String ID = makeID(ElectroBurst.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (m != null) {
            addToBot(new SparkVFXAction(m, 0.25f));
            addToBot(new SparkVFXAction(m, 0.25f));
    ...
    public AbstractCard makeCopy() {
        AbstractCard tmp = new ElectroBurst();
